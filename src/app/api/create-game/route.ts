...
export default AIGeneratedGame;`,
    ...
    console.log("=== END CREATE GAME REQUEST ===");
    ...
    console.error("=== END CREATE GAME ERROR ===");
...
export async function GET(request: NextRequest) {
  console.log("=== CREATE GAME GET REQUEST ===");
  console.log("Timestamp:", new Date().toISOString());
  console.log("URL:", request.url);
  console.log("=== END CREATE GAME GET REQUEST ===");

  return NextResponse.json({
    message: "Create Game API is running",
    endpoints: {
      POST: "/api/create-game - Create a new AI-generated game",
      GET: "/api/create-game - Get API status",
    },
    exampleRequest: {
